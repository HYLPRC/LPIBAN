...
class DrugBAN(nn.Module):
    def __init__(self, **config):
        ...
        # self.drug_extractor = ProteinCNN(protein_emb_dim, num_filters, kernel_size, protein_padding)
        self.drug_extractor = ProteinACmix(protein_emb_dim, num_filters, protein_num_head, protein_padding)
